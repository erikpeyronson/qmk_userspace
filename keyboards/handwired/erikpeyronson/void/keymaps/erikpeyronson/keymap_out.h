...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_5(
          ...
          KC_NO, MY_LT(LAYER_NAV,KC_BSPC), MY_LT(LAYER_SYM,KC_BSPC), MY_LT(LAYER_NUM,KC_DEL), KC_NO,       KC_NO, MY_LT(LAYER_NUM, KC_ENT), MY_LT(LAYER_SYM,KC_SPC), MY_LT(LAYER_NAV, KC_SPC), KC_NO
    ),
    ...
    [2] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                 KC_NO, TG(LAYER_NAV), TG(LAYER_SYM), TG(LAYER_NUM), KC_NO,         KC_NO, TG(LAYER_NUM), TG(LAYER_SYM), TG(LAYER_NAV), KC_NO
    ),
