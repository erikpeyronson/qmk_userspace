...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                                 KC_PLUS, KC_1, KC_2, KC_3, KC_SLSH, LT(ETC,KC_DOT),
    ...
    [SYM] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                                 KC_TILD, KC_SCLN, KC_DQUO, KC_LCBR, KC_RCBR, LT(ETC, KC_PIPE),
         KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, MO(ETC),           MO(ETC), KC_TRNS, KC_TRNS, KC_TRNS, KC_NO
    ),
